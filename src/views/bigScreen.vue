...
<script>
import doubleArea from "./echartsPart/doubleArea.vue";
import worldMap from "./echartsPart/worldMap.vue";
import test from "./echartsPart/test.vue";
export default {
  components: {
    doubleArea,
    worldMap,
